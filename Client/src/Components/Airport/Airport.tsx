...
const Airport = () => {
  ...
  const handleClick = () => {
    fetch("https://localhost:7263/api/airport/starttimer");
  };
          ...
          <div className="mid-container">
           <Title />
            ...
            <div className="left-table">
              <UpdateTable planeListData={planeListData} checkFunc={checkArriving} tableTitle="Arriving"/>
            </div>
            <div className="right-table">
            <UpdateTable planeListData={planeListData} checkFunc={checkDeparting} tableTitle="Departing"/>
            </div>
